import { Product1688, Product1688Schema, PriceTier, SKUVariation, Raw1688Data } from '../types/product-1688'
 ...
 */
export function normalize1688Product(raw: Raw1688Data, sourceUrl: string): Product1688 {
    ...
    if (raw.skuInfoMap && typeof raw.skuInfoMap === 'object') {
        Object.entries(raw.skuInfoMap).forEach(([skuId, skuInfo]: [string, any]) => {
            skus.push({
                ...
                stock:
                    skuInfo.canBookCount || skuInfo.stock ? Number(skuInfo.canBookCount || skuInfo.stock) : undefined,
