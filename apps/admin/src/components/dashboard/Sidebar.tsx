...
import { LayoutDashboard, Users, UserCheck, Settings, ChevronLeft, ChevronRight, Calculator, Package } from 'lucide-react'
...
const navigation = [
    ...
    { name: '1688 Products', href: '/dashboard/1688-products', icon: Package, roles: ['OWNER', 'ADMIN'] },
