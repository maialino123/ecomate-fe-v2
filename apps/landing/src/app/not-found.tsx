    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#dee1e1] to-[#f4f4f4] dark:from-slate-950 dark:to-slate-900">
      ...
      >
        ...
        >
          ...
          Đừng lo lắng, hãy quay về trang chủ để khám phá thêm những điều thú vị với EcoMate!
        </motion.p>
        ...
        >
          <HoverBorderButton borderColor="rgba(16, 185, 129, 0.8)" glowIntensity={0.7}>
            <HoverBorderButton.Link href="/" className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-3 rounded-xl font-semibold text-base flex items-center gap-2 transition-all duration-300">
