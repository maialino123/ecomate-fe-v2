                ...
                <main className="mx-auto max-w-3xl px-6 py-16 text-slate-900">
                    ...
                    <section className="prose prose-invert prose-emerald max-w-none space-y-6">
                        <p className="text-slate-900/80 leading-relaxed">
                            Bạn có thể yêu cầu <strong className="text-slate-900">đổi hoặc trả trong 7 ngày</strong> kể
                            từ khi nhận hàng đối với các trường hợp:
                        </p>
                        ...
                        <div className="mt-8">
                            <h2 className="text-2xl font-semibold text-slate-900 mb-4">Điều kiện áp dụng</h2>
                            <ul className="list-disc list-inside space-y-2 text-slate-900/80">
                        ...
                        <div className="mt-8">
                            <h2 className="text-2xl font-semibold text-slate-900 mb-4">Quy trình hỗ trợ</h2>
                            <ol className="list-decimal list-inside space-y-2 text-slate-900/80">
                        ...
                        <div className="mt-8 p-6 rounded-xl border border-emerald-600/30 bg-emerald-950/20">
                            <h3 className="text-lg font-semibold text-slate-900 mb-2">Lưu ý quan trọng</h3>
                            <p className="text-sm text-slate-900/70">
                                Ecomate cam kết xử lý mọi yêu cầu đổi/trả một cách nhanh chóng và minh bạch. Thời gian
                                xử lý thường từ 3-5 ngày làm việc kể từ khi nhận được sản phẩm hoàn trả.
                            </p>
                        </div>
                    </section>
                </main>
